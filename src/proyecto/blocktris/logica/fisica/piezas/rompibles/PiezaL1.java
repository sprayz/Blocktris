...
public class PiezaL1 extends PiezaBase {
	...
	public PiezaL1(PhysicsWorld mundo, float x, float y, float tamaño_bloque,
		...
		bloques.add(new Bloque(mundo,cuerpo,-1,-1.5f,tamaño_bloque,ColorBloque.AZUL ,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,0,-1.5f,tamaño_bloque,ColorBloque.AZUL,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,0,-0.5f,tamaño_bloque,ColorBloque.AZUL ,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,0,0.5f,tamaño_bloque,ColorBloque.AZUL ,IPieza.FIXTUREDEF_DEFECTO ));
