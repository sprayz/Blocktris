...
public class PiezaLlave1 extends PiezaBase {
	...
	public PiezaLlave1(PhysicsWorld mundo, float x, float y, float tamaño_bloque,
		...
		bloques.add(new Bloque(mundo,cuerpo,0.5f,-1f,tamaño_bloque,ColorBloque.VERDE ,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,-0.5f,-1f,tamaño_bloque,ColorBloque.VERDE ,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,-0.5f,-0f,tamaño_bloque,ColorBloque.VERDE ,IPieza.FIXTUREDEF_DEFECTO ));
		bloques.add(new Bloque(mundo,cuerpo,-1.5f,0f,tamaño_bloque,ColorBloque.VERDE ,IPieza.FIXTUREDEF_DEFECTO ));
